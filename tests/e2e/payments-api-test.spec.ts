...
test.describe('Payments API Test', () => {
  test('should test payments API directly', async ({ page }) => {
    ...
    // Check if payments data is loaded in the component
    ...
    await page.screenshot({ path: 'payments-api-test.png', fullPage: true });
