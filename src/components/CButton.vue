...
const { variant } = defineProps({
  variant: {
    ...
    validator: (value) =>
      ['default', 'primary', 'secondary-circle'].includes(value), // Ensure valid values
  },
});

// Base classes for all buttons
const baseClasses =
  'font-medium inline-flex items-center gap-2 disabled:cursor-not-allowed disabled:text-gray-400 focus:outline-none transition-all';
